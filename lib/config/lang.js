const languageConfig = {
  zh: {
    ...
    switchUserCommand: {
      commandDescription: '切换当前git的global用户',
      inquirerIssue: '请选择一个用户并设置为当前global用户：',
      confirmSwtich: '确定将该用户设置为当前global用户吗[默认:y]',
      actionSucceeded: '切换用户成功！'
    },
    removeCommand: {
  ...
  en: {
    ...
    switchUserCommand: {
      commandDescription: 'switch the global user of the current Git',
